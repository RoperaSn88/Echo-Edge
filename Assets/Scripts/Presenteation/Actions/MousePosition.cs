...
//     version 1.16.0
//     from Assets/Actions/MousePosition.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Actions/MousePosition.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @MousePosition: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Mouse"",
            ""id"": ""a750fb0a-ff35-4682-8508-534036c401c0"",
            ""actions"": [
                {
                    ""name"": ""MousePos"",
                    ""type"": ""Value"",
                    ""id"": ""ea8afe0d-e60d-469c-9332-fafbfa8dcc5a"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""2a08dc78-8c4f-486e-a77f-cd1d92b6d47f"",
    ...
    ~@MousePosition()
    {
        UnityEngine.Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, MousePosition.Mouse.Disable() has not been called.");
    }
    ...
    public struct MouseActions
    {
        ...
        /// </summary>
        public MouseActions(@MousePosition wrapper) { m_Wrapper = wrapper; }
        /// <summary>
