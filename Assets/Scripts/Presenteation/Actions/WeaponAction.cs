...
//     version 1.16.0
//     from Assets/Actions/WeaponAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Actions/WeaponAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @WeaponAction: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Mouse"",
            ""id"": ""eaf61e81-03fb-4944-bf93-840ff51e9a0e"",
            ""actions"": [
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""b7e47c2f-0845-49df-aed4-ec0d55cb6d74"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Scroll"",
                    ""type"": ""Value"",
                    ""id"": ""9cafe955-76b3-4fb0-903a-e1d369fb5db8"",
                ...
                },
                {
                    ""name"": ""WeaponCancel"",
                    ""type"": ""Button"",
                    ""id"": ""79114747-905c-4fbd-a64b-a9fde5367a04"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""075cc652-d949-4c2d-a6cf-bc10d58ec1a6"",
                    ""path"": ""<Pointer>/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""ac1d476c-7bef-4251-be1e-b9c411c84a73"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""4d79b116-8bf5-474e-a6e6-53848c33feaf"",
    ...
    ""controlSchemes"": []
        ...
        m_Mouse_WeaponCancel = m_Mouse.FindAction("WeaponCancel", throwIfNotFound: true);
    }

    ~@WeaponAction()
    {
        UnityEngine.Debug.Assert(!m_Mouse.enabled, "This will cause a leak and performance issues, WeaponAction.Mouse.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Mouse_WeaponCancel;
    /// <summary>
    ...
    public struct MouseActions
    {
        ...
        /// </summary>
        public MouseActions(@WeaponAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "Mouse/WeaponCancel".
        /// </summary>
        public InputAction @WeaponCancel => m_Wrapper.m_Mouse_WeaponCancel;
        /// <summary>
        ...
        public void AddCallbacks(IMouseActions instance)
        {
            ...
            @WeaponCancel.started += instance.OnWeaponCancel;
            @WeaponCancel.performed += instance.OnWeaponCancel;
            @WeaponCancel.canceled += instance.OnWeaponCancel;
        }
    ...
    public interface IMouseActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "WeaponCancel" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnWeaponCancel(InputAction.CallbackContext context);
    }
}
